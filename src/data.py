...
def get_data_loaders(
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",
        # DONE: add the appropriate transform that you defined in
    ...
    valid_sampler = torch.utils.data.SubsetRandomSampler(valid_idx) # DONE
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # obtained
    images, labels  = next(dataiter) # DONE
    ...
    class_names  = data_loaders["train"].dataset.classes # DONE
